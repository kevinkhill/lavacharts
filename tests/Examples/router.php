...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            #lavachart{width:99%}
            .float{float:left;margin-left:20px;}
            .grey{background-color:#f3f3f3;border:1px solid #666}
            ul{list-style-type:none;margin:0;padding:0}li{font:200 16px/1.5 Helvetica,Verdana,sans-serif;border-bottom:1px solid #ccc}li:last-child{border:none}li a{text-decoration:none;color:#000;display:block;width:200px;-webkit-transition:font-size .2s ease,background-color .2s ease;-moz-transition:font-size .2s ease,background-color .2s ease;-o-transition:font-size .2s ease,background-color .2s ease;-ms-transition:font-size .2s ease,background-color .2s ease;transition:font-size .2s ease,background-color .2s ease}li a:hover{font-size:20px;background:#f6f6f6}
        </style>
    </head>
    <body>
        <div id="logo">
