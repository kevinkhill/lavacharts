...
$stocksTable = Lavacharts::DataTable('Stocks');
...
Lavacharts::LineChart('Stocks')->title('Stock Market Trends');</pre>
                    </div>
                </div>
...
echo Lavacharts::LineChart('Stocks')->outputInto('stock_div');
echo Lavacharts::div(1000, 400);

if(Lavacharts::hasErrors())
{
    echo Lavacharts::getErrors();
}</pre>
                    </div>
                </div>
    <!-- /Basic -->
...
<!--End Pie Charts-->
	...
	<div class="section s4">
            <div class="inner">
                <h1 class="title">Column Charts</h1>
                <h2>Basic</h2>
                <h2>Advanced</h2>
            </div>
	</div>
